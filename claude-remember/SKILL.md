...
when_to_use: |
  ...
  Trigger phrases: "review my memories", "organize memories", "promote to CLAUDE.md",
...
1. **Project memory**: `CLAUDE.md` and `.claude/CLAUDE.md` in project root
2. **Local memory**: `CLAUDE.local.md` in project root
3. **User memory**: `~/.claude/CLAUDE.md` (global for all projects)
4. **Auto-memory**: Check if there's auto-memory content in the system prompt
